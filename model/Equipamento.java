...
public abstract class Equipamento implements Monitoravel {
    ...
    // Retorna a data de instalação do equipamento.
    public LocalDate getDataInstalação() {
        return this.dataInstalação;
    }
    
    public int getID() { return this.ID; }
    public LocalDate getUltimaVerificação() { return this.ultimaVerificação; }
    public int getVidaUtil() { return this.vidaUtil; }
    public int getFrequenciaManutencoes() { return this.frequenciaManutenções; }
    
    public static int getContaID() { return contaID; }
    public static void registrarProblema() { problemas++; }
    public static int getTotalProblemas() { return problemas; }
    ...
    public abstract void simularFalha();
}
